...
<head>
    ...
    <!-- StyleSheets  -->
    <link rel="stylesheet" href="/css/dashlite.css?ver=3.1.1">
    <link id="skin-default" rel="stylesheet" href="/css/theme.css?ver=3.1.1">
</head>
                        ...
                        <div class="nk-split-content nk-block-area nk-block-area-column nk-auth-container bg-white">
                            ...
                            <div class="nk-block nk-block-middle nk-auth-body">
                                ...
                                <div class="nk-block-head">
                                    <div class="nk-block-head-content">
                                        ...
                                        <div class="nk-block-des">
                                            <p>Access rental mobil panel using your email and passcode.</p>
                                        </div>
                                    </div>
                                </div><!-- .nk-block-head -->
                                <form method="POST" action="{{ route('loginnow') }}">
                                    @csrf
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input autocomplete="email" type="email"
                                                ...
                                                placeholder="Enter your email address" autofocus> @error('email')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            ...
                                            <input autocomplete="current-password"
                                                ...
                                                placeholder="Enter your password"> @error('password')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                            @enderror
                                ...
                                <div class="form-note-s2 pt-4"> New on our platform? <a
                                        href="{{ route('users.create') }}">Create an account</a>
                                </div>
                                    ...
                                    <div class="slider-item">
                                        <div class="nk-feature nk-feature-center">
                                            <div class="nk-feature-img">
                                                <img class="round" src="./images/slides/nissan.jpg"
                                                    srcset="./images/slides/promo-b2x.png 2x" alt="">
                                            </div>
                                            <div class="nk-feature-content py-4 p-sm-5">
                                                <h4>Rental Mobil</h4>
                                                <p>Rental mobil dimana saja kapan saja dengan website semakin mudah.</p>
                                            </div>
                                        </div>
                                    </div><!-- .slider-item -->
